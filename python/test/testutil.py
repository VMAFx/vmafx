...
def set_default_576_324_videos_for_testing_scaled():
    ...
    asset = Asset(
        ...
        ref_path=ref_path,
        dis_path=dis_path,
        asset_dict={"width": 576, "height": 324, "dis_enc_width": 480, "dis_enc_height": 270},
    )
...
def set_default_576_324_10bit_videos_for_testing_b():
    ...
    asset = Asset(
        ...
        ref_path=ref_path,
        dis_path=dis_path,
        asset_dict={"width": 576, "height": 324, "yuv_type": "yuv420p10le"},
    )
...
def set_default_576_324_12bit_videos_for_testing():
    ...
    asset = Asset(
        ...
        ref_path=ref_path,
        dis_path=dis_path,
        asset_dict={"width": 576, "height": 324, "yuv_type": "yuv420p12le"},
    )
...
def set_default_576_324_16bit_videos_for_testing():
    ...
    asset = Asset(
        ...
        ref_path=ref_path,
        dis_path=dis_path,
        asset_dict={"width": 576, "height": 324, "yuv_type": "yuv420p16le"},
    )
...
def set_default_cambi_video_for_testing_b():
    ...
    asset = Asset(
        ...
        ref_path=dis_path,
        dis_path=dis_path,
        asset_dict={"width": 1280, "height": 720, "dis_enc_width": 960, "dis_enc_height": 540},
    )
