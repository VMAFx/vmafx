...
class VmafV1QualityRunnerTest(MyTestCase):
    ...
    def test_v1016_integer_1080_3d0H_exec(self):
        ...
        self.runner = VmafexecQualityRunner(
            ...
            result_store=None,
            optional_dict={
                "model_filepath": VmafConfig.model_path("vmaf_v1.0.16", "vmaf_v1.0.16_3d0h.json")
            },
        )
        self.runner.run()
        ...
        self.assertAlmostEqual(
            results[0]["VMAFEXEC_adm3_csf_2_dlmw_0.7_egl_1_min_0.5_nw_0.02_score"],
            0.9482851666666666,
            places=5,
        )
        self.assertAlmostEqual(
            results[0]["VMAFEXEC_motion3_mmxv_18_score"], 3.9897647708333337, places=5
        )
        self.assertAlmostEqual(
            results[0]["VMAFEXEC_cambi_hrs_1080_cmxv_17_vlt_0.06_encbd_8_ench_324_encw_576_score"],
            0.2596781458333333,
            places=5,
        )
        self.assertAlmostEqual(
            results[0]["VMAFEXEC_speed_chroma_uv_mxv_45_nnf_0.1_snn_0.19_wvm_5_score"],
            6.141235312500001,
            places=5,
        )
    ...
    def test_v1016_integer_hfr_1080_3d0H_exec(self):
        ...
        self.assertAlmostEqual(
            results[0]["VMAFEXEC_motion3_mffw_mmxv_18_mma_score"], 6.828103625, places=5
        )
        self.assertAlmostEqual(
            results[0]["VMAFEXEC_cambi_hrs_1080_cmxv_17_vlt_0.06_encbd_8_ench_324_encw_576_score"],
            0.2596781458333333,
    ...
    def test_v1016_integer_2160_3d0H_exec(self):
        ...
        self.assertAlmostEqual(
            results[0]["VMAFEXEC_adm3_csf_2_dlmw_0.7_egl_1_min_0.5_nw_0.02_rdh_2160_score"],
            0.9595838749999999,
            places=5,
        )
        self.assertAlmostEqual(
        ...
        self.assertAlmostEqual(
            results[0][
                "VMAFEXEC_speed_chroma_uv_mxv_45_nnf_0.1_ps_0.5_psm_bilinear_snn_0.19_wvm_5_score"
            ],
            0.0,
            places=5,
        )
    ...
    def test_v1016_integer_2160_1d5H_exec(self):
        ...
        self.assertAlmostEqual(
            results[0]["VMAFEXEC_adm3_csf_2_dlmw_0.7_egl_1_min_0.5_nw_0.02_nvd_1.5_rdh_2160_score"],
            0.9482851666666666,
            places=5,
        )
        self.assertAlmostEqual(
            results[0]["VMAFEXEC_motion3_mmxv_18_score"], 3.9897658541666665, places=5
        )
        self.assertAlmostEqual(
            results[0]["VMAFEXEC_cambi_hrs_1080_cmxv_17_vlt_0.06_encbd_8_ench_324_encw_576_score"],
            0.2596781458333333,
    ...
    def test_v1016_integer_1080_5d0H_exec(self):
        ...
        self.runner = VmafexecQualityRunner(
            ...
            result_store=None,
            optional_dict={
                "model_filepath": VmafConfig.model_path("vmaf_v1.0.16", "vmaf_v1.0.16_5d0h.json")
            },
        )
        self.runner.run()
        ...
        self.assertAlmostEqual(
            results[0]["VMAFEXEC_adm3_csf_2_dlmw_0.7_egl_1_min_0.5_nw_0.02_nvd_5_score"],
            0.9564286041666666,
            places=5,
        )
        self.assertAlmostEqual(
        ...
        self.assertAlmostEqual(
            results[0][
                "VMAFEXEC_speed_chroma_uv_mxv_45_nnf_0.1_ps_0.6_psm_bilinear_snn_0.19_wvm_5_score"
            ],
            0.0,
            places=5,
        )
    ...
    def test_v1016_integer_hfr_2160_1d5H_exec(self):
        ...
        self.assertAlmostEqual(
            results[0]["VMAFEXEC_motion3_mffw_mmxv_18_mma_score"], 6.828103333333334, places=5
        )
        self.assertAlmostEqual(
            results[0]["VMAFEXEC_cambi_hrs_1080_cmxv_17_vlt_0.06_encbd_8_ench_324_encw_576_score"],
            0.2596781458333333,
