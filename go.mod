...
// TODO(golusoris-v0.9.0): drop both replaces once golusoris v0.9.0 and core/v0.9.0 are tagged.
replace github.com/golusoris/golusoris => C:/Users/ms/dev/golusoris/golusoris
