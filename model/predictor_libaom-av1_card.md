# `predictor_libaom-av1` — VMAF predictor model card

- **Codec adapter**: `libaom-av1`
- **Training date**: 2026-05-08
- **ONNX opset**: 18
- **Graph nodes**: 10
- **File**: `model/predictor_libaom-av1.onnx` (21877 bytes)
- **SHA-256**: `9d7934f9cf62c258fc0bb7fdc5fd0985b2eb2419610d3e8c66adc4686a0acbe1`
...
Per-shot VMAF predictor for the `libaom-av1` adapter. Consumed by
