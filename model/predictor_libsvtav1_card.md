# `predictor_libsvtav1` — VMAF predictor model card

- **Codec adapter**: `libsvtav1`
- **Training date**: 2026-05-08
- **ONNX opset**: 18
- **Graph nodes**: 10
- **File**: `model/predictor_libsvtav1.onnx` (21877 bytes)
- **SHA-256**: `1d420329342ddaa0eeb0d1f5611c334baf43787212b2e0eb6e2f1abf7f7c3d81`
...
Per-shot VMAF predictor for the `libsvtav1` adapter. Consumed by
