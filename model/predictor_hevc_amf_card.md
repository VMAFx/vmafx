# `predictor_hevc_amf` — VMAF predictor model card

- **Codec adapter**: `hevc_amf`
- **Training date**: 2026-05-08
- **ONNX opset**: 18
- **Graph nodes**: 10
- **File**: `model/predictor_hevc_amf.onnx` (21877 bytes)
- **SHA-256**: `77be6ef3933841b980958e8f46ae41bfed956f12d65dc5efc3b8715064079eab`
...
Per-shot VMAF predictor for the `hevc_amf` adapter. Consumed by
