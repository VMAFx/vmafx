# `predictor_h264_amf` — VMAF predictor model card

- **Codec adapter**: `h264_amf`
- **Training date**: 2026-05-08
- **ONNX opset**: 18
- **Graph nodes**: 10
- **File**: `model/predictor_h264_amf.onnx` (21877 bytes)
- **SHA-256**: `b75e4853ec4ff66269d6fd520d6797de644125a06d0e027476a5e2d01577effe`
...
Per-shot VMAF predictor for the `h264_amf` adapter. Consumed by
