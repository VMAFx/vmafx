# `predictor_libvvenc` — VMAF predictor model card

- **Codec adapter**: `libvvenc`
- **Training date**: 2026-05-08
- **ONNX opset**: 18
- **Graph nodes**: 10
- **File**: `model/predictor_libvvenc.onnx` (21877 bytes)
- **SHA-256**: `8c061d222555c558715d76d4dab8cde9ac7771c58f093b45f313d1ba5cc00b58`
...
Per-shot VMAF predictor for the `libvvenc` adapter. Consumed by
