# `predictor_libx264` — VMAF predictor model card

- **Codec adapter**: `libx264`
- **Training date**: 2026-05-08
- **ONNX opset**: 18
- **Graph nodes**: 10
- **File**: `model/predictor_libx264.onnx` (21877 bytes)
- **SHA-256**: `7cae3b3ebe02803c819811bf5aa4e6aad92e49df46a2095fbee49244399adb25`
...
Per-shot VMAF predictor for the `libx264` adapter. Consumed by
