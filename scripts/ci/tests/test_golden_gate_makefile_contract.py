...
class GoldenGateMakefileContractTest(unittest.TestCase):
    ...
    def test_golden_build_dir_variable_defined(self):
    ...
    def test_build_golden_target_defined(self):
    ...
    def test_test_netflix_golden_depends_on_build_golden_not_build(self):
    ...
    def test_test_netflix_golden_exports_vmaf_build_dir(self):
    ...
    def test_clean_target_removes_golden_build_dir(self):
