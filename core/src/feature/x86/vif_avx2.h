...
void vif_filter1d_8_avx2(const VifBuffer *buf, unsigned w, unsigned h);
...
void vif_filter1d_16_avx2(const VifBuffer *buf, unsigned w, unsigned h, int scale, int bpc);
