...
#ifndef X86_SPEED_MATMUL_AVX2_H_
#define X86_SPEED_MATMUL_AVX2_H_

/* Bit-exact AVX2 twin of speed_matmul_scalar(); see feature/speed_matmul.h
...
#endif /* X86_SPEED_MATMUL_AVX2_H_ */
