...
void ciede_preprocess_8_avx512(const uint8_t *y_buf, const uint8_t *u_buf, const uint8_t *v_buf,
...
void ciede_preprocess_16_avx512(const uint16_t *y_buf, const uint16_t *u_buf, const uint16_t *v_buf,
                                float *out_y, float *out_u, float *out_v, int w)
{
    int j = 0;
