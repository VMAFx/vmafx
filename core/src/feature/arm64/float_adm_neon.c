 ...
 * kernel uses explicit split multiply/add arithmetic to match the scoped
 * non-contracting `adm_dwt2_s` reference. Separating it ensures no other TU
 * inherits this contraction contract.
