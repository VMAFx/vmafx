...
`core/tools/`, `mcp-server/`, `scripts/`, `tools/`, `.workingdir2/` state
...
5. Suggest next action (cross-reference with `.workingdir2/BACKLOG.md`
   and `docs/state.md`).
...
- [`scripts/dev/test_project_modernization_audit.py`](../../../scripts/dev/test_project_modernization_audit.py)
  = pytest coverage
- [`.workingdir2/BACKLOG.md`](../../../.workingdir2/BACKLOG.md) (gitignored)
  = prioritized intent
