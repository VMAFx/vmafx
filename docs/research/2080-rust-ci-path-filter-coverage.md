...
- **Date**: 2026-09-23
- **Author**: lusoris
- **Governing issue**: `T-PATH-FILTERS-WEAKEN-NEW-GATES-2026-09-22` (docs/state.md)
...
This defect was explicitly tracked in `docs/state.md` under `T-PATH-FILTERS-WEAKEN-NEW-GATES-2026-09-22` and in comments inside `.github/workflows/rust-ci.yml`.
