...
| `libsvtav1`         | AV1   | CPU     | [ADR-0294](../adr/0294-vmaf-tune-codec-adapter-svtav1.md)  | Accepted         | no       | SVT-AV1 preset 0–13 mapped from `--preset` slug. Supports `libsvtav1@svt-av1-hdr` runtime variant with `-svtav1-params` tuning knobs. |
