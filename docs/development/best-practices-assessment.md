...
| [`test_invocation`](https://www.bestpractices.dev/en/criteria/0#test_invocation) | SHOULD | Evidence | Use `make test`, the credential-safe Meson runner, and documented package-specific test entrypoints. |
